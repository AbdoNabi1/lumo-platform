...
| **Apps / Services**                                       | `apps/storefront` (Next.js shell), `apps/admin/prototype` (**frozen** UI HTML), `services/example` (walking-skeleton reference — non-business), `services/{catalog,media,pricing,inventory}` (Phase 1 contexts; in-memory persistence)                                           |
...
- **Next:** Sprint 1.3 — Cart. See [PROJECT_STATE.md](PROJECT_STATE.md).
