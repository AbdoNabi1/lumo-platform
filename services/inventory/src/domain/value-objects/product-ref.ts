...
/**
 * A reference to a Catalog product/variant by **bare id** — no cross-context import or FK. Stock is
 * tracked against this reference; the product is owned by the Catalog context.
 */
